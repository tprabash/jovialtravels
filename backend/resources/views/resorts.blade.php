...
<!-- Mirrored from designreset.com/cork/html/vertical-light-menu/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 09:02:02 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>Jovial Travels</title>
                    ...
                    <div class="col-xl-12 col-12  layout-spacing mt-4">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form action="{{ url('resorts-add') }}" method="POST" enctype="multipart/form-data">
                                    
                                            @csrf

                                        <div class="mb-3">
                                            <label for="">Resort Name</label>
                                            <input type="text" name="resort_name"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Title</label>
                                            <input type="text" name="resort_title"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Main Background Image</label>
                                            <input type="file" name="resort_main_bak_img"  class="form-control form-control-sm">
                                        </div>

                                        <div class="mb-3">
                                            <label for="">Resort First Small Image</label>
                                            <input type="file" name="resort_first_sm_img"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort First Big Image</label>
                                            <input type="file" name="resort_first_bg_img"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort First Content Title</label>
                                            <input type="text" name="resort_first_content_title"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort First Content 1</label>
                                            <input type="text" name="resort_first_content_one"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort First Content 2</label>
                                            <input type="text" name="resort_first_content_second"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort First Content 3</label>
                                            <input type="text" name="resort_first_content_third"  class="form-control form-control-sm">
                                        </div>
                                        
                                        <div class="mb-3">
                                            <label for="">Resort Second Small Image</label>
                                            <input type="file" name="resort_second_sm_img"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Second Big Image</label>
                                            <input type="file" name="resort_second_bg_img"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Second Content Title</label>
                                            <input type="text" name="resort_second_content_title"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Second Content 1</label>
                                            <input type="text" name="resort_second_content_one"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Second Content 2</label>
                                            <input type="text" name="resort_second_content_second"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort First Content 3</label>
                                            <input type="text" name="resort_first_content_third"  class="form-control form-control-sm">
                                        ...
                                        <div class="mb-3">
                                            <label for="">Resort Third Small Image</label>
                                            <input type="file" name="resort_third_sm_img"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Third Big Image</label>
                                            <input type="file" name="resort_third_bg_img"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Third Content Title</label>
                                            <input type="text" name="resort_third_content_title"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Third Content 1</label>
                                            <input type="text" name="resort_third_content_one"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort Third Content 2</label>
                                            <input type="text" name="resort_third_content_second"  class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-3">
                                            <label for="">Resort First Content 3</label>
                                            <input type="text" name="resort_first_content_third"  class="form-control form-control-sm">
...
<!-- Mirrored from designreset.com/cork/html/vertical-light-menu/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 09:02:39 GMT -->
</html>