                    ...
                    <div class="col-xl-12 col-12  layout-spacing mt-4">
                            <div class="statbox widget box box-shadow">
                                ...
                                <form action="{{ url('offers-add') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="">Header Content 1</label>
                                        <input type="text" name="header_content_1"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Header Content 2</label>
                                        <input type="text" name="header_content_2"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 1</label>
                                        <input type="text" name="content_1"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 2</label>
                                        <input type="text" name="content_2"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 3</label>
                                        <input type="text" name="content_3"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 4</label>
                                        <input type="text" name="content_4"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 5</label>
                                        <input type="text" name="content_5"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 6</label>
                                        <input type="text" name="content_6"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 7</label>
                                        <input type="text" name="content_7"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 8</label>
                                        <input type="text" name="content_8"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 9</label>
                                        <input type="text" name="content_9"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Content 10</label>
                                        <input type="text" name="content_10"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Footer Content 1</label>
                                        <input type="text" name="footer_content_1"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Footer Content 2</label>
                                        <input type="text" name="footer_content_2"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Footer Content 3</label>
                                        <input type="text" name="footer_content_3"  class="form-control form-control-sm">
                                    </div>
                                    <div class="mb-3">
