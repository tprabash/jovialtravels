...
Route::group(['middleware' => 'auth'], function () {
    Route::get('/home', [App\Http\Controllers\OfferController::class, 'index'])->name('offer');
    ...
    Route::get('/partners', [App\Http\Controllers\ResortController::class, 'partnersList'])->name('partners');
