...
export default function Form() {
    ...
    const handleChangechildren = (event) => {
     ...
     const checkBoxTypeOfHoliday = (event) => {
       ...
       }, [setBoxTypeTiketValue]);

       const checkBoxTypeOftiket = (event) => {
     
        let newArray3 = [...BoxTypeOfTiketValue, event.target.value, ];
        if (BoxTypeOfTiketValue.includes(event.target.value)) {
          newArray3 = newArray3.filter(day2 => day2 !== event.target.value);
        }
        setBoxTypeTiketValue(newArray3)
    ...
    <div className='form_jovial'>
        ...
        <Grid item xs={6} >
                            ...
                            <Grid item xs={6}>
                                ...
                                >
                                <MenuItem value={1}>1 nights</MenuItem>
                                <MenuItem value={1}>2 nights</MenuItem>
                            ...
                            <Grid  className="margin-around-form mt-4" item xs={12}>
                                    ...
                                    <Grid  className="margin-around-form mt-4" item xs={12}>
                                    <FormLabel component="legend">I would like to see my package including flight tickets  </FormLabel>
                                    <FormGroup row>

                                    <FormControlLabel onChange={checkBoxTypeOftiket} control={<Checkbox  name="checkBoxTypeOftiketYes" value="yes" />} label="Yes"/>
                                    <FormControlLabel onChange={checkBoxTypeOftiket} control={<Checkbox name="checkBoxTypeOftiketNo" value="no"  /> } label="No"/>
        ...
        >
          ...
          <MenuItem value={1}>USD 4000 -  USD5000</MenuItem>
          <MenuItem value={2}>USD 6000 - USD 8000</MenuItem>
          <MenuItem value={3}>USD 8000-  USD 9000</MenuItem>
          <MenuItem value={4}>USD 10000 and Above</MenuItem>
        </Select>
